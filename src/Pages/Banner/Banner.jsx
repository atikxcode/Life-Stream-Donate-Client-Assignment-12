...
const Banner = () => {
  return (
    ...
    <div className='w-full h-[250px] md:h-[450px] lg:h-[750px] xl:h-[750px] flex flex-col items-center justify-center'>
      <div className='flex items-center flex-col gap-8'>
      <h2 className="text-3xl md:text-4xl lg:text-5xl text-white font-semibold leading-tight text-center p-4">
