...
const BlogDetails = () => {
  ...
  const {_id, content, image, status} = blog
       ...
       <div className="w-full mx-auto container my-32"  data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500" >
          <div className=" bg-[#1b1b1b]">
           ...
           <div className="flex flex-col   h-full items-start p-8 bg-[#1b1b1b] opacity-70">
            ...
            <p className="text-2xl mb-2 text-orange-500">{blog.title}</p>
            <p className="text-[14px] mb-2 text-orange-500 w-[800px]">Content: {blog.content}</p>
